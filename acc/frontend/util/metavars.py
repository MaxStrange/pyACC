...
class MetaVars:
    ...
    def __init__(self, *, src=None, stackframe=None, signature=None,
        ...
        @param callers_mods: The modules (and aliases of those modules) which
                             are known to the caller of the acc-decorated
                             function
        ...
        @param funcs_mods: The modules (and aliases of those modules) which are
                           known to the function and which are used by the
                           function
        @param funcs_funcs: The function source code for the functions that
                            the acc-decorated function has access to and calls
