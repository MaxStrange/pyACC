...
class MetaVars:
    ...
    def __init__(self, *, src=None, stackframe=None, signature=None,
        ...
        @param callers_funcs:   The function source code for the functions that
        ...
        @param funcs_funcs:     The function source code for the functions that
        ...
        @param region_src:      The region of the original acc-decorated
                                function that the current directive is
                                concerned with

        @param region_vars:     The variables of the original acc-decorated
                                function that the current directive is
                                concerned with
        """
        self.src = src
    ...
    def __str__(self):
        ...
        s += "region_src: " + os.linesep + str(self.region_src) + os.linesep
        s += "region_vars: " + os.linesep + str(self.region_vars) + os.linesep
        s += ")"
